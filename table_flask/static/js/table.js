...
//var dropDownCountry = document.getElementById("countries");
//var dropDownRegion = document.getElementById("regions");
//var dropDownYear = document.getElementById("years");
//var rankElement = document.getElementById("rank");

/* MAIN ACTIVITY */

// load country data
d3.json("/countries").then(countryData => {
    ...
    function handleFilter (event) {
        ...
        var inputRegion = d3.select("#regions").property("value");
        ...
        var filteredData = countryData.filter( d => {            
            ...
            if (inputCountry === "all" || inputCountry === d.country) {
                if (inputRegion === "all" || inputRegion === d.region) {
